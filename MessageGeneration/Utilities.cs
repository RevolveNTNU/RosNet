...
internal class Utilities
{
    internal const string BLOCK_COMMENT =
        @"/* 
 * This message is auto generated by RosBagNet. Please DO NOT modify.
 * Note:
...
";
    ...
    internal const string PROPERTY_EXTENSION = " { get; set; }";
    ...
    internal static string LowerFirstLetter(string s)
    {
